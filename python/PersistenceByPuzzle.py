...
# persistence = computePersistenceByPuzzle(dataEvents)
...
categoryPuzzle = ['1. One Box~Tutorial', '2. Separated Boxes~Tutorial', '3. Rotate a Pyramid~Tutorial', '4. Match Silhouettes~Tutorial', '5. Removing Objects~Tutorial', '6. Stretch a Ramp~Tutorial', '7. Max 2 Boxes~Tutorial', '8. Combine 2 Ramps~Tutorial', '9. Scaling Round Objects~Tutorial', 
               'Square Cross-Sections~Intermediate', 'Bird Fez~Intermediate', 'Pi Henge~Intermediate', '45-Degree Rotations~Intermediate',  'Pyramids are Strange~Intermediate', 'Boxes Obscure Spheres~Intermediate', 'Object Limits~Intermediate', 'Not Bird~Advanced', 'Angled Silhouette~Intermediate',
               'Warm Up~Advanced','Tetromino~Advanced', 'Stranger Shapes~Advanced', 'Sugar Cones~Advanced', 'Tall and Small~Advanced', 'Ramp Up and Can It~Advanced', 'More Than Meets Your Eye~Advanced', 'Unnecessary~Advanced', 'Zzz~Advanced', 'Bull Market~Advanced', 'Few Clues~Advanced', 'Orange Dance~Advanced', 'Bear Market~Advanced']


typeMapping = ['1. One Box~Tutorial', '2. Separated Boxes~Tutorial', '3. Rotate a Pyramid~Tutorial', '4. Match Silhouettes~Tutorial', '5. Removing Objects~Tutorial', '6. Stretch a Ramp~Tutorial', '7. Max 2 Boxes~Tutorial', '8. Combine 2 Ramps~Tutorial', '9. Scaling Round Objects~Tutorial', 
...
def computePersistenceByPuzzle(dataEvents, group = 'all'):
